    ...
    return (
        <>
            <BoxHeader>
                ...
                <CreatePostDialog getPostInfo={requestBody => { createPost(requestBody) }} />
            </BoxHeader>
            <BoxBody>
                <ClassScheduleTableWrapper>
                    <table>
                        ...
                        <tbody>
                            {
                                posts.length > 0 ? posts.map((elem, index) => {
                                    return (
                                        <tr key={index}>
                                            <th>{elem.id}</th>
                                            <th>{elem.title}</th>
