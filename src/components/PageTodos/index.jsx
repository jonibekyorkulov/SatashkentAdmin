...
import { createTodoReq } from './requests'
import { useSelector } from 'react-redux'
import CustomizedInputSimple from '../CustomizedInputSimple'
import CreateTodoDialog from '../CreateTodoDialog'
import { posts_add, todos_add } from '../../utils/API_urls'
...
export default function PageTodos() {
    ...
    const createTodo = (requestBody) => {
        createTodoReq(todos_add, {
    ...
    return (
        <>
            <BoxHeader>
                ...
                <CreateTodoDialog getPostInfo={requestBody => { createTodo(requestBody) }} />
            </BoxHeader>
            <BoxBody>
