...
import { BoxBody, BoxHeader, ClassScheduleTableWrapper, BoxFooter, BoxFooterText, AttendSearchButton } from '../../global_styles/styles'
import PageSelector from '../PageSelector'
import { TableTHHeader } from '../ExampleTable'
import { createUserReq, getUser } from './requests'
import { Box, Button, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, Slide, Pagination } from '@mui/material'
    ...
    return (
        <>
            <BoxHeader>
                ...
                <CreateUser getPostInfo={requestBody => { createUser(requestBody) }} />
            </BoxHeader>
            <BoxBody>
