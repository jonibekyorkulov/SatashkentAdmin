...
import CreatePractices from '../CreatePractices'
...
export default function PagePractices() {
    ...
    return (
        <>
            <BoxHeader>
                ...
                />
                <ModalSelectWrapper>
                    <Checkbox {...label} />InProcess
                </ModalSelectWrapper>
                <AttendSearchButton>
                    <CustomizedInput callback_func={(val) => { console.log(val) }} />
                </AttendSearchButton>
                <CreatePractices getPostInfo={requestBody => { createUser(requestBody) }} />
            </BoxHeader>
            <BoxBody>
                                ...
                                users.length > 0 ? users.map((elem, index) => {
                                    return (
                                        <tr key={index}>
                                            ...
                                            <th>{elem?.birthDate}</th>
                                            <th>{elem?.birthDate}</th>
                                            <th>
                                                <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <rect width="16" height="16" rx="2" fill="#039E51"/>
                                                    <path d="M12.6667 4.66667L6.66667 10.6667L3.33333 7.33333" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                                                </svg>

                                            </th>
                                            <th>
                                                <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <rect width="16" height="16" rx="2" fill="#a32136"/>
                                                    <path d="M4 4L12 12" stroke="white" strokeWidth="2" strokeLinecap="round"/>
                                                    <path d="M4 12L12 4" stroke="white" strokeWidth="2" strokeLinecap="round"/>
                                                </svg>
                                            ...
                                            <th>
                                                ...
                                                <Button
                                                    ...
                                                    // onClick={() => { setSelectPage(elem); handleClickOpen(); }}
                                                    startIcon={<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
